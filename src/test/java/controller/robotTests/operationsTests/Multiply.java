...
public class Multiply extends TestingSandBox {
    ...
    public void randomMultiplyScenarios() {
        ...
        mouseInputTest("0,0000000000000005 * 0,0000000000000231 ms c 0,000000000000032 sqr m+ mr mc", "2,310000000000102e-14", "");
        ...
        mouseInputTest("0,0000000000000003 * 0,0000000000004326 * 0,00000000021 = ms c 0,000000000009584 sqr m+ mr mc", "9,185305600000003e-23", "");
        ...
        mouseInputTest("5000000000000000 * 2310000000000000 ms c 320000000000000 sqr m+ mr mc", "1,024000000000023e+29", "");
        ...
        mouseInputTest("0,000061231 ms * 0,00000000614 = m+ mr mc", "6,123100037595834e-5", "");
        mouseInputTest(MIN_INPUT + " * 0,11 + 0,00000031 =", "3,10000000011e-7", "1,1e-17 + 0,00000031 = ");
        mouseInputTest("0,00005234 ms * 0,00000000121 = m+ mr mc", "5,23400000633314e-5", "");

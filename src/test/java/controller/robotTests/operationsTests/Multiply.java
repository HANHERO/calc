...
public class Multiply extends TestingSandBox {
    ...
    public void randomMultiplyScenarios() {
        ...
        mouseInputTest(",4865258684 * ,0000000008 = = =", "", "");
        ...
        mouseInputTest(MIN_INPUT + " * 0,1 =", "9,9999999999991e-4", "1e-17 + 0,0009999999999999 = ");
        mouseInputTest(MIN_INPUT + " * 0,000545 =", "6,4000000002e-7", "2e-17 + 0,00000064 = ");

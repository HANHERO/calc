...
public class Add extends TestingSandBox {
    ...
    public void randomAddScenarios() {
        ...
        mouseInputTest("453345565 sqr + = = = = =", "485 546 000 849", "594845151 + 484951155698 = ");
        ...
        mouseInputTest("3465757565432 + 484951155698 = ", "485 546 000 849", "594845151 + 484951155698 = ");
        mouseInputTest(MIN_INPUT + " * 0,42 + 0,0000003 =", "3,00000000042e-7", "4,2e-17 + 0,0000003 = ");
        mouseInputTest("5948451514232221 sqr + = = =", "485 546 000 849", "594845151 + 484951155698 = ");
        ...
        mouseInputTest("7345645644566 sqr + = = =", "485 546 000 849", "594845151 + 484951155698 = ");
        mouseInputTest("65444334533 sqr + = = =", "485 546 000 849", "594845151 + 484951155698 = ");
        mouseInputTest("3456547567345 sqr + = = =", "485 546 000 849", "594845151 + 484951155698 = ");
        mouseInputTest("0,0000345654756734 sqr + = = =", "485 546 000 849", "594845151 + 484951155698 = ");

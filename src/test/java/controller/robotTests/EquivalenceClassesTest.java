...
public class EquivalenceClassesTest extends TestingSandBox {
    ...
    public void boundaryScenarios() {
        ...
        mouseInputTest(NEAREST_TO_ZERO_POSITIVE_NUMBER + " plusMinus * 0,9999999999999999 =", OVERFLOW, "negate( 1e-9999 ) × 0,9999999999999999 = ");
    }
    ...
    public void equivalenceClassesScenarios() {
        ...
        mouseInputTest(MAX_INPUT + " + 0,5 = ms c 0,0000000000000001 m- 1 m- c mr mc", "9 999 999 999 999 998", "");
    ...
    public void realizationScenarios() {
        ...
        mouseInputTest("4324 plusMinus del del", "-43", "");
